...
def parse_args():
    ...
    parser.add_argument('--network', dest='network_name',
                        ...
                        default=None, type=str)
    parser.add_argument('--inference_iter', dest='inference_iter', default=3, type=int)
...
if __name__ == '__main__':
    ...
    if args.multi_label == 1:
        imdb = get_imdb_multi(args.roidb, args.imdb, args.rpndb, args.data_dir, split=0)
    else:
        imdb = get_imdb(args.roidb, args.imdb, args.rpndb, args.data_dir, split=0)
