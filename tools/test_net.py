...
def parse_args():
    ...
    parser.add_argument('--test_mode', dest='test_mode',
                        default='fg', type=str)
    parser.add_argument('--load_score', dest='test_mode',
                        default=None, type=str) 
...
if __name__ == '__main__':
    ...
    imdb = get_imdb(args.roidb, args.imdb, args.rpndb, args.data_dir, split=2, num_im=args.test_size)
    if args.test_mode == 'viz_cls' or args.test_mode == 'viz_det':  # visualize result
        ...
        eval_net(score_file imdb, args.test_mode)
    else:
