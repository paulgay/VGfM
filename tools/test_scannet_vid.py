...
from fast_rcnn.visualize import viz_net_vid
...
if __name__ == '__main__':
    ...
    if args.multi_label == 1:
        imdb = get_imdb_multi(args.roidb, args.imdb, args.rpndb, args.data_dir, split=1, num_im=args.test_size)
    else:
    ...
    if args.test_mode == 'viz_cls' or args.test_mode == 'viz_det':  # visualize result
        viz_net_vid(args.network_name, args.model, imdb, args.dump_file, args.test_mode)
