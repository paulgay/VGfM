...
# on zero-padding.
__C.TRAIN.ASPECT_GROUPING = False # all my images are the same, and the code breaks if the number of images is odd
...
#__C.VG_DIR = osp.abspath('/ssd_disk/gay/scenegraph/synth/')
#__C.VG_DIR = osp.abspath('/ssd_disk/gay/scenegraph/gt_quad_sem/')
#__C.VG_DIR = osp.abspath('/ssd_disk/gay/scenegraph/pers_cons_quad_sem/')
