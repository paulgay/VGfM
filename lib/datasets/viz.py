...
def viz_scene_graph(im, rois, labels, inds=None, rels=None, preprocess=True, save_f='image.png'):
    """
    ...
    return _viz_scene_graph(im, viz_rois, viz_labels, viz_rels, preprocess, save_f)


def _viz_scene_graph(im, rois, labels, rels=None, preprocess=True, save_f='image.png'):
    if preprocess:
